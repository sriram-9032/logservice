...
import com.dtt.logs.service.impl.PaymentsLogImpl;
import com.dtt.logs.service.impl.PaymentsLogPageImpl;
...
@RequestMapping("/payments-log/api")
@RestController
public class PaymentsLogController {

    private final PaymentsLogImpl auditService;

    private final PaymentsLogPageImpl pageService;



    MongoTemplate mongoTemplate;

    public PaymentsLogController(PaymentsLogImpl auditService, PaymentsLogPageImpl pageService,  MongoTemplate mongoTemplate) {
        this.auditService = auditService;
        this.pageService = pageService;
        this.mongoTemplate = mongoTemplate;
    }

    @KafkaListener(topics = "${payments.log.topic}", groupId = "kyc-logs", containerFactory = "auditDTOServiceContainerFactory")
    public void getMessage(AuditDTO auditDTO)  {
        try {
            System.out.println("Listening to ob.log.topic");
