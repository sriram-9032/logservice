...
import com.dtt.logs.service.impl.RaLogImpl;
...
import com.dtt.logs.service.impl.RaLogPageImpl;
...
@RequestMapping("/ra-log/api")
@RestController
public class RaLogController {

    private final RaLogImpl auditService;

    private final RaLogPageImpl pageService;



    MongoTemplate mongoTemplate;

    public RaLogController(RaLogImpl auditService, RaLogPageImpl pageService,  MongoTemplate mongoTemplate) {
        this.auditService = auditService;
        this.pageService = pageService;
        this.mongoTemplate = mongoTemplate;
    }

    @KafkaListener(topics = "${ra.log.topic}", groupId = "kyc-logs", containerFactory = "auditDTOServiceContainerFactory")
    public void getMessage(AuditDTO auditDTO)  {
        try {
            System.out.println("Listening to ra.log.topic");
