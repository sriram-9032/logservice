...
import com.dtt.logs.service.impl.AdminLogImpl;
...
@RequestMapping("/admin-log/api")

@RestController
public class AdminLogController {

    private final AdminLogImpl auditService;

    public AdminLogController(AdminLogImpl auditService) {
        this.auditService = auditService;
    }


    @KafkaListener(topics = "${admin.log.topic}", groupId = "kyc-logs", containerFactory = "auditDtoContainerFactory")
    public void getMessage( AuditDto jsonObj) throws JsonProcessingException {
        ...
        try{
            System.out.println("Listening to admin.log.topic");
    ...
    public String postAuditLogsByFilters(@PathVariable("page") int page,@Validated @RequestBody PageDto pageDTO)
    {
        ...
        int perpage= (perPage==null)?10:perPage;
        try{
