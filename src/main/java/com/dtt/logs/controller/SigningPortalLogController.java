...
@RequestMapping("/signing-portal/api")
@RestController
public class SigningPortalLogController {

    private final SigningPortalAdminLogImpl auditService;

    private final SigningPortalPageImpl pageService;

    MongoTemplate mongoTemplate;

    public SigningPortalLogController(SigningPortalAdminLogImpl auditService, SigningPortalPageImpl pageService, MongoTemplate mongoTemplate) {
        this.auditService = auditService;
        this.pageService = pageService;
        this.mongoTemplate = mongoTemplate;
    }

    @KafkaListener(topics = "${service.log.topic}", groupId = "kyc-logs", containerFactory = "auditDTOServiceContainerFactory")
    public void getMessage(AuditDTO auditDTO) {
        System.out.println("Listening to signing-portal-topic :: outside try block");
        try {
            System.out.println("Listening to signing-portal-topic");
