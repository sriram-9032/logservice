...
@Document("daycountmodels")
public class CountLog {
    
    private int countOfServiceProviders;
    
    private int countOfCertificates;
...
//    @Indexed(unique = true)
    ...
    public String toString() {
        return "CountLog{" +
                "countOfServiceProviders=" + countOfServiceProviders +
    ...
    public int getCountOfServiceProviders() {
        return countOfServiceProviders;
    }

    public void setCountOfServiceProviders(int countOfServiceProviders) {
        this.countOfServiceProviders = countOfServiceProviders;
    }

    public int getCountOfCertificates() {
        return countOfCertificates;
    }

    public void setCountOfCertificates(int countOfCertificates) {
