...
@Document("subTransactionsLog")
public class SubTransactionsLog {
        ...
        public SubTransactionsLog(
                ...
                Boolean eSealUsed,
                String checksum,
                String deviceId, String sdkType, String sdkVersion, String transactionPrice) {
