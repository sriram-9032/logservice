...
import com.dtt.logs.repository.payments.PaymentsAuditRepository;
import com.dtt.logs.service.iface.RaLogIface;
...
@Service
@Qualifier("paymentsLogMongoTemplate")
public class PaymentsLogImpl implements RaLogIface {

    private final PaymentsAuditRepository auditRepository;

    private final MongoTemplate mongoTemplate;

    public PaymentsLogImpl(PaymentsAuditRepository auditRepository,@Qualifier("paymentsLogMongoTemplate") MongoTemplate mongoTemplate) {
