...
import com.dtt.logs.repository.signingPortal.SigningPortalAuditRepository;
import com.dtt.logs.service.iface.SigningPortalLogIface;
...
@Service
@Qualifier("signingPortalLogMongoTemplate")
public class SigningPortalAdminLogImpl implements SigningPortalLogIface {

    private final SigningPortalAuditRepository auditRepository;

    private final MongoTemplate mongoTemplate;

    //
    public SigningPortalAdminLogImpl(SigningPortalAuditRepository auditRepository,@Qualifier("signingPortalLogMongoTemplate")  MongoTemplate mongoTemplate) {
