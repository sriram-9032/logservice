...
import com.dtt.logs.repository.ra.RaAuditRepository;
...
@Service
@Qualifier("raLogMongoTemplate")
public class RaLogImpl implements RaLogIface {

    private final RaAuditRepository auditRepository;


    private final MongoTemplate mongoTemplate;

    public RaLogImpl(RaAuditRepository auditRepository, @Qualifier("raLogMongoTemplate") MongoTemplate mongoTemplate) {
