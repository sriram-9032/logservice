...
import com.dtt.logs.repository.signing.SigningAuditRepository;
import com.dtt.logs.service.iface.SigningLogIface;
...
@Service
@Qualifier("signingLogMongoTemplate")
public class SigningLogImpl implements SigningLogIface {

    private final SigningAuditRepository auditRepository;


    private final MongoTemplate mongoTemplate;

    public SigningLogImpl(SigningAuditRepository auditRepository, @Qualifier("signingLogMongoTemplate")MongoTemplate mongoTemplate) {
