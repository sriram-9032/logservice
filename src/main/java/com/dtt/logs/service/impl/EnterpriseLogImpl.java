...
import com.dtt.logs.repository.enterprise.EnterpriseRepo;
import com.dtt.logs.service.iface.EnterpriseLogIface;
...
@Service
public class EnterpriseLogImpl implements EnterpriseLogIface {

    private final EnterpriseRepo adminAuditRepository;

    private final MongoTemplate mongoTemplate;

    public EnterpriseLogImpl(EnterpriseRepo adminAuditRepository, MongoTemplate mongoTemplate) {
    ...
    public Page<AdminAuditLog> matchFilters(PageDto pageDTO, Pageable pageable)
    {
        ...
        Page<AdminAuditLog> auditPage=new PageImpl<>(auditLogList,pageable,recCount);
        return auditPage;
